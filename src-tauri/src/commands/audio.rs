...
pub use platform::audio::{PermissionAccess, WindowsMicrophonePermissionStatus};
...
pub fn get_windows_microphone_permission_status() -> WindowsMicrophonePermissionStatus {
    platform::audio::microphone_permission_status()
}

#[tauri::command]
#[specta::specta]
pub fn open_microphone_privacy_settings() -> Result<(), String> {
    platform::audio::open_microphone_privacy_settings()
}
